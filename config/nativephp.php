...
return [
    ...
    */
    ...
    'app_id' => env('NATIVEPHP_APP_ID', 'com.bookbound.mobile'),
    ...
    */
    ...
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'bookbound'),
    ...
    */
    ...
    'deeplink_host' => env('NATIVEPHP_DEEPLINK_HOST', parse_url(config('app.url'), PHP_URL_HOST)),
