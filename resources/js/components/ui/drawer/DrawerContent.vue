...
<template>
    <DrawerPortal>
        ...
        <DrawerContent
            ...
            v-bind="forwarded"
            :class="cn(
                `group/drawer-content overflow-hidden fixed z-50 flex h-auto flex-col bg-popover/60 dark:bg-white/20 p-1 pb-0 shadow-xs backdrop-blur-[1px]`,
        ...
        >
            <div class="bg-background rounded-t-[21px]">
